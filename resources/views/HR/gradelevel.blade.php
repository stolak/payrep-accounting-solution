										...
										<table class="table table-hover table-center mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a class="btn btn-sm bg-success-light" href="javascript: editfunc('{{$list->id}}','{{$list->grade}}')">
							...
							<form method="post" >
								...
								<div class="row ">
									<div class="col-12 col-sm-12">
										<div class="form-group">
											<label>Grade</label>
											<input type="text" id="grade" name="grade"  class="form-control" style="text-align: left;"  autocomplete="off">
										</div>
									</div>
							    </div>
