            ...
            @if (!empty($projectId))
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Field Expense</h4>
                            </div>
                            <div class="card-body">
                                <form method="post">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="text-right">
                                        <button type="submit" class="btn btn-primary" name="addnew">Add Field
                                            Expense</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                                        ...
                                                        <td>
                                                            @if ($expense->status != 'Approved')
                                                                <a class="btn btn-sm bg-success-light"
                                                                    href="javascript: editfunc('{{ $expense->id }}','{{ $expense->budgetId }}','{{ $expense->paymentMilestoneId }}','{{ $expense->debit }}','{{ $expense->transactionDate }}','{{ addslashes($expense->description) }}')">
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="8" class="text-center">No field expense records found
                                                        for this project.</td>
                                                </tr>
                                            @endif
                                        </tbody>
...
@section('scripts')
    ...
    <script>
        ...
        function editfunc(id, budgetId, paymentMilestoneId, amount, transactionDate, description) {
