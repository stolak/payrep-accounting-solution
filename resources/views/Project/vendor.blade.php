                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ Str::limit($vendor->description ?? 'N/A', 100) }}
                                                </td>
                                                <td>
                                                    @if ($vendor->accountName)
                                                        {{ $vendor->accountName }} ({{ $vendor->accountNo }})
                                                    @else
                                                        N/A
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm bg-success-light"
                                                        href="javascript: editfunc('{{ $vendor->id }}','{{ $vendor->name }}','{{ addslashes($vendor->description ?? '') }}','{{ $vendor->accountId }}','{{ $vendor->status }}')">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" id="accountId" name="accountId">
                                            <option value="">--Select Account--</option>
                                            @foreach ($accountLookUp as $account)
                                                <option value="{{ $account->id }}">{{ $account->accountdescription }} ({{ $account->accountno }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
        function editfunc(id, name, description, accountId, status) {
